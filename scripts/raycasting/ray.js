class Ray{
    ...
    render(){
        stroke("rgba(240, 255, 0, 0.3)");           
        line(
            MINI_MAP_SCALE*player.x,                                     //starting point x
            MINI_MAP_SCALE*player.y,                                     //starting point y
            MINI_MAP_SCALE*this.wallHitX,                                //ending point x
            MINI_MAP_SCALE*this.wallHitY                                 //ending point y 
        );
    }
}